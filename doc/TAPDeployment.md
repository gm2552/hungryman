...
**NOTE:**  If you have chosen AppSSO as well as TAP Spring Cloud gateway as configuration options, there is a possibility that the Gateway component will fail to 
deploy due to the AppSSO secret not being ready.  If this occurs, delete the Spring Cloud Gateway instance and rerun the `kubectl create ns service-instances` command.
